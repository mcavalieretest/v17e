 ...
 * Version $Id: ww.js 3850 2014-05-07 20:11:48Z mcavaliere $
 * Owner: Corporate Webmaster (NUS_N_NIWWW)
 * Copyright (c) 2013 IBM Corporation
 */

// URI: <???>/common/v17e/js/w3.js
...
/**
	...
	##  NOTE
	####
	This is the exact same same as www.js except for these items:
		- We get the w3 version of v17 (first line below).
		- Mobile menu search field (search for "m-search-module"). It points to w3 instead of www
		- Bottom of file includes a $=jQuery patch until v17 w3.js gets fixed, then take that out.
	
**/
// load w3 ibm v17 dojo
document.write('<script type="text/javascript" src="' + '//1.w3.s81c.com/common/js/dojo/w3.js' + '"></' + 'script>');
    ...
    IBM.Common.Widget.MobileMenu = (function() {
        ...
        function insertMobileMenuHtml() {
			...
			jQuery('#m-shift').prepend(
                '<div id="m-menu" class="m-menu">' + '<div id="m-search-module">' + '<form id="m-search-form" action="http://w3.ibm.com/search/do/search" method="get">' + '<input id="m-q" value="" maxlength="100" name="qt" type="text" placeholder="search w3" />' + '<input type="submit" id="m-search" class="ibm-btn-search" value="Submit"/>' + '</form>' + '</div>'

                + '<div id="m-menu-scroll">' + '<div id="m-main-menu">' + '<h2>w3</h2>' + '<ul>' + mastLinks + '</ul>' + '</div>' + '</div>' + '</div>'
            );
...
//********************************************************************************************
//********************************************************************************************
	// Required here until w3.js v17 is fixed.
	$ = jQuery;
//********************************************************************************************
//********************************************************************************************
//********************************************************************************************
