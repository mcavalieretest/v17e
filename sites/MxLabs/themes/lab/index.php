                        ...
                        <div class="ibm-columns" id="ibm-lead-1">
                            <div class="ibm-col-1-1">                                
                                <div class="ibm-col-6-3 feature-box">
                                    ...
                                    <p><span style="opacity: 1">We started off as a pilot team in 2011, launched a digital design lab in 2012, and grew to 24 teams with 160 people by 2013. This year we’ve expanded globally and opened three new Labs in Tokyo, London, and Bangalore. We’re here to share our experiences with you—the successes, the failures, and the lessons we learn along the way. </span></p>
                                </div>
                            </div>
                        </div>
                        <div class="ibm-columns" id="ibm-lead-2">
                            <div class="ibm-col-1-1">
                                <div class="ibm-col-6-3 feature-box">
                                    ...
                                    <p><span style="opacity: 1">IBM doesn’t exactly see itself as the kind of company that belongs in an unconventional neighborhood. But as a monolith a little out of its comfort zone, it’s hard not to feel a kind of kinship with 51 Astor Place.</span></p>
                                </div>
                            </div>
                        </div>
