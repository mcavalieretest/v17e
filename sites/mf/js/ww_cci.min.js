...
(function(e, t, n, r) {
    e(function() {
        var t = e(".ibm-sortable");
        t.masonry({
            columnWidth: 300,
            gutter: 20,
            itemSelector: ".ibm-card"
        });
        e(".ibm_cci-sort").on("change", "select", function(n) {
            var r = n.currentTarget.value, i = [], s;
            t.find(".ibm-card").each(function() {
                s = t.masonry("getItem", this);
                r == "" || e(this).hasClass(r) ? i.push(s) : e(this).hide();
            });
            t.masonry("reveal", i).masonry();
        });
    });
