...
(function(e, t, n, r) {
    e(function() {
        var t = /(Mobile|iPhone|Blackberry)/gi.test(navigator.userAgent), n = e(".ibm-sortable"), r = n.find(".ibm-card"), i;
        if (!t) {
            e.getScript("//www.ibm.com/software/common-content/ssi/lp/lpdyn-common.js");
            e("span.phone a").replaceWith(e("span.phone a").text());
        } else e("body").addClass("callingEnabled");
        n.masonry({
            columnWidth: ".ibm-card",
            gutter: 20,
            itemSelector: ".ibm-card",
            transitionDuration: t ? 0 : "0.4s"
        });
        e(".ibm_cci-sort").on("change", "select", function(e) {
    ...
    function r(e) {
        function r(e) {
            if ("string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                for (var c = s.isBorderBox = !!l && !!r[l] && "border-box" === r[l], d = 0, v = u.length; v > d; d++) {
                    var m = u[d], g = r[m];
                    g = i(e, g);
                    var y = parseFloat(g);
                    s[m] = isNaN(y) ? 0 : y;
                }
                var b = s.paddingLeft + s.paddingRight, w = s.paddingTop + s.paddingBottom, E = s.marginLeft + s.marginRight, S = s.marginTop + s.marginBottom, x = s.borderLeftWidth + s.borderRightWidth, T = s.borderTopWidth + s.borderBottomWidth, N = c && f, C = t(r.width);
                C !== !1 && (s.width = C + (N ? 0 : b + x));
                var k = t(r.height);
                return k !== !1 && (s.height = k + (N ? 0 : w + T)), s.innerWidth = s.width - (b + x), s.innerHeight = s.height - (w + T), s.outerWidth = s.width + E, s.outerHeight = s.height + S, s;
            }
        }
        function i(e, t) {
            if (s || -1 === t.indexOf("%")) return t;
            var n = e.style, r = n.left, i = e.runtimeStyle, o = i && i.left;
            return o && (i.left = e.currentStyle.left), n.left = t, t = n.pixelLeft, n.left = r, o && (i.left = o), t;
        }
        var f, l = e("boxSizing");
        return function() {
            if (l) {
                ...
                n.appendChild(e);
                var r = o(e);
                f = 200 === t(r.width), n.removeChild(e);
            }
        }(), r;
    }
    var i = document.defaultView, s = i && i.getComputedStyle, o = s ? function(e) {
        return i.getComputedStyle(e, null);
    } : function(e) {
        return e.currentStyle;
    }, u = [ "paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth" ];
    "function" == typeof define && define.amd ? define("get-size/get-size", [ "get-style-property/get-style-property" ], r) : e.getSize = r(e.getStyleProperty);
}(window), function(e, t) {
    function n(e, t) {
        return e[u](t);
    }
