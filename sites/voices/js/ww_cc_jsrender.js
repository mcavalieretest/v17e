$(function() {
    ...
    $(".ibm_cci--ls--toggle ul.ibm_cci--ls--toggle--ul").children().each(function() {
        var toggleButton = $(this);
        toggleButton.on("click", "a", function(event) {
    ...
    $.when(vo.f_fetch_trending(), vo.f_fetch_feeds()).done(function(results, data) {
        ...
        $(".ibm_cci__ml-li").on("click", function(event) {
            vo.f_addspinner();
            // VARIABLES DECLARED
            var clickedTrendingName = $(event.target).attr("name").trim(), parentP = $(event.target).parent();
    ...
    var vo = {
        ...
        reTweetToggle: function() {
            $("#ibm_cci-widget-js ul.ibm_cci-relatedTweetContainer li").on("click", "a", function(event) {
                ...
                targetParent_li = eventTarget.parent();
                targetParent_a_dataID = eventTarget.parent().attr("data-userid");
                targetDiv = eventTarget.parentsUntil("div.ibm-col-1-1").children('div[data-userid="' + targetParent_a_dataID + '"]');
...
(function(e, t, n, v) {
    ...
    r.special.smartresize = {
        ...
        _getColumns: function() {
            ...
            this.columnWidth += this.options.gutterWidth, this.cols = Math.floor((t + this.options.gutterWidth) / this.columnWidth), 
        ...
        function a(e) {
            var n = e.target;
            n.src !== s && t.inArray(n, o) === -1 && (o.push(n), --i <= 0 && (setTimeout(u), 
