                ...
                $("li.ibm_cci__ml_t a[name='all']").on("click", function(event) {
                        ...
                        if ($("p#ibm_cci__ml_t-js").hasClass("ibm_cci-clicked")) {
                            ...
                            vo.f_fetch_feeds().done(function(data) {
                                ...
                                $(".ibm-sortable").append($(".ibm-card")).masonry("appended", $(".ibm-card")); setTimeout(function() {
                                    $("#ibm_cci-widget-js").masonry();
                                }, 400);
                                if (vo.searchterms.length == 0) $(window).data("ajaxReq", true); alertText.html('');
                            });
                    }
                });
                ...
                try {
                    if (searchterms.length === 0) {
                        self.f_fetch_feeds().done(function(data) {
                                ...
                                // if(data.entries.length
                                < 20) $(window).data("ajaxReq", false); self.f_reTweetToggle(); $("#ibm_cci__ml_t-js").addClass("ibm_cci-clicked"); $("#ibm_cci-widget-js").masonry("reload"); setTimeout(function() {
                                $("#ibm_cci-widget-js").masonry();
                            }, 400);
                        });
